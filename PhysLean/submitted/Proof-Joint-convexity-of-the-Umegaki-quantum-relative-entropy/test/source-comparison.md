...
| 7 | The proof is `sorry`-free: `#print axioms` = `[propext, Classical.choice, Quot.sound]` | The Lean kernel (recorded in commit `f901e353`; reproducible by `../verify.sh`) | ✅ | kernel |
