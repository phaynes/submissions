...
| 7 | The proof is `sorry`-free: `#print axioms` = `[propext, Classical.choice, Quot.sound]` | The Lean kernel (recorded in commit `720c9fff`; reproducible by `../verify.sh`) | ✅ | kernel |
